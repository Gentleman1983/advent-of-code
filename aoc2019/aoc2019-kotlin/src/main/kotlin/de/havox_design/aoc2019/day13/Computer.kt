...
class Computer(
    ...
    var inputSupplier: ((Int) -> Long)? = null,
    val resumeOnOutput: Boolean = false
) {
    ...
    private fun Long.opCodePositions() =
        this
            .toString()
            .padStart(5, '0')
            .substring(0, 3)
    ...
    private fun Long.isHaltOpcode() =
        this == 99L

    private fun Long.isAddOpCode() =
        this
            .toString()
            .endsWith("1")

    private fun Long.isMulOpCode() =
        this
            .toString()
            .endsWith("2")

    private fun Long.isInputOpCode() =
        this
            .toString()
            .endsWith("3")

    private fun Long.isOutputOpCode() =
        this
            .toString()
            .endsWith("4")

    private fun Long.isJumpIfTrueOpCode() =
        this
            .toString()
            .endsWith("5")

    private fun Long.isJumpIfFalseOpCode() =
        this
            .toString()
            .endsWith("6")

    private fun Long.isLessThanOpCode() =
        this
            .toString()
            .endsWith("7")

    private fun Long.isEqualsOpCode() =
        this
            .toString()
            .endsWith("8")

    private fun Long.isAdjustRelativeAddress() =
        this
            .toString()
            .endsWith("9")

    private fun addCommand(mode: String) =
        mathCommand(mode) { o1, o2 -> o1 + o2 }

    private fun mulCommand(mode: String) =
        mathCommand(mode) { o1, o2 -> o1 * o2 }
    ...
    private fun isLessThan(modes: String) =
        compareCommand(modes) { x, y -> x < y }

    private fun jumpIfFalse(modes: String) =
        jumpCommand(modes) { it == 0L }

    private fun jumpIfTrue(modes: String) =
        jumpCommand(modes) { it != 0L }
