...
class Day01Test {
    ...
    void testTask1(String fileName, long expectation) {
        Assertions.assertEquals(expectation, TheTyrannyOfTheRocketEquation.processTask1(fileName));
    }
    ...
    void testTask2(String fileName, long expectation) {
        Assertions.assertEquals(expectation, TheTyrannyOfTheRocketEquation.processTask2(fileName));
    }
