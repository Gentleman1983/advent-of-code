...
class Day20Test {
    ...
    void testTask1(String fileName, long expectedFloor) {
        Assertions.assertEquals(expectedFloor, Day20.processTask1(fileName));
    }

    private static Stream<Arguments> getDataForTask1() {
        return Stream.of(
                Arguments.of("de/havox_design/aoc2019/day20/day20part1sample.txt", 0L)
        );
    }
    ...
    void testTask2(String fileName, long expectedStep) {
        Assertions.assertEquals(expectedStep, Day20.processTask2(fileName));
    }
