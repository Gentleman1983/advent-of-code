...
class Day08Test {
    ...
    void testTask1(String fileName, long expectedFloor) {
        Assertions.assertEquals(expectedFloor, Day08.processTask1(fileName));
    }

    private static Stream<Arguments> getDataForTask1() {
        return Stream.of(
                Arguments.of("de/havox_design/aoc2019/day08/day08part1sample.txt", 0L)
        );
    }
    ...
    void testTask2(String fileName, long expectedStep) {
        Assertions.assertEquals(expectedStep, Day08.processTask2(fileName));
    }
