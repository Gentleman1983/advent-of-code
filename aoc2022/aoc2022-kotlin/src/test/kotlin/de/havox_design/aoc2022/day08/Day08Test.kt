...
class Day08Test {
    ...
    @ParameterizedTest
    @CsvSource("de/havox_design/aoc2022/day08/day08Sample.txt,21")
    ...
    @ParameterizedTest
    @CsvSource("de/havox_design/aoc2022/day08/day08Sample.txt,8")
    ...
    companion object {
        ...
        private fun getDataForTestReadWoodByFile(): Stream<Arguments> =
            Stream.of(
                Arguments.of(
                    "de/havox_design/aoc2022/day08/day08Sample.txt",
                    listOf(
        ...
        private fun getDataForTestTreeVisibility(): Stream<Arguments> =
            Stream.of(
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 1, 1, true),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 1, 2, true),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 1, 3, false),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 2, 1, true),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 2, 2, false),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 2, 3, true),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 3, 1, false),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 3, 2, true),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 3, 3, false)
            )

        @JvmStatic
        private fun getDataForTestTreeVisibilityByDirection(): Stream<Arguments> =
            Stream.of(
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 1, 1, true, false, false, true),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 1, 2, true, true, false, false),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 1, 3, false, false, false, false),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 2, 1, false, true, false, false),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 2, 2, false, false, false, false),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 2, 3, false, true, false, false),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 3, 1, false, false, false, false),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 3, 2, false, false, true, true),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 3, 3, false, false, false, false)
            )

        @JvmStatic
        private fun getDataForTestCalculateScenicScore(): Stream<Arguments> =
            Stream.of(
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 1, 2, 4),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 3, 2, 8)
            )

        @JvmStatic
        private fun getDataForTestCalculateScenicScoreByDirection(): Stream<Arguments> =
            Stream.of(
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 1, 2, 1, 2, 2, 1),
                Arguments.of("de/havox_design/aoc2022/day08/day08Sample.txt", 3, 2, 2, 2, 1, 2)
            )
    }
}
