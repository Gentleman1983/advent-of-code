...
class Day12Test {
    ...
    companion object {
        ...
        private fun getDataForTestReadFile(): Stream<Arguments> =
            Stream.of(
                Arguments.of(
                    "de/havox_design/aoc2022/day12/day12Sample.txt",
                    mapOf(
                        Pair(Position(0, 0), Field("S")),
                        Pair(Position(1, 0), Field("a")),
                        Pair(Position(2, 0),Field( "b")),
        ...
        private fun getDataForTestPart1(): Stream<Arguments> =
            Stream.of(
                Arguments.of("de/havox_design/aoc2022/day12/day12Sample.txt", 31)
            )

        @JvmStatic
        private fun getDataForTestPart2(): Stream<Arguments> =
            Stream.of(
                Arguments.of("de/havox_design/aoc2022/day12/day12Sample.txt", 29)
            )
    }
}
