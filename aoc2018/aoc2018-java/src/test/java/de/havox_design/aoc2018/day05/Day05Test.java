...
class Day05Test {
    ...
    void testTask1(String fileName, long expectedFloor) {
        Assertions.assertEquals(expectedFloor, Day05.processTask1(fileName));
    }

    private static Stream<Arguments> getDataForTask1() {
        return Stream.of(
                Arguments.of("de/havox_design/aoc2018/day05/day05part1sample.txt", 0L)
        );
    }
    ...
    void testTask2(String fileName, long expectedStep) {
        Assertions.assertEquals(expectedStep, Day05.processTask2(fileName));
    }
