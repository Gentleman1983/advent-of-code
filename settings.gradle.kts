...
include("templates")
include("templates:groovy")
include("templates:groovy:aoc20xx-groovy")
include("templates:java")
include("templates:java:aoc20xx-java")
include("templates:kotlin")
include("templates:kotlin:aoc20xx-kotlin")
include("templates:python")
include("templates:python:aoc20xx-python")
include("templates:scala")
include("templates:scala:aoc20xx-scala")
