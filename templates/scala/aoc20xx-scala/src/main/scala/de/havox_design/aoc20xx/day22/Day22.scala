...
object Day22 {
  ...
  def main(args: Array[String]): Unit = {
    println("Solution for part1: " + solvePart1("de/havox_design/aoc20xx/day22/day22.txt"))
    println("Solution for part2: " + solvePart2("de/havox_design/aoc20xx/day22/day22.txt"))
  }
