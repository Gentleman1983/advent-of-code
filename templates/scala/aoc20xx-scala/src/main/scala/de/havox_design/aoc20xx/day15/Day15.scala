...
object Day15 {
  ...
  def main(args: Array[String]): Unit = {
    println("Solution for part1: " + solvePart1("de/havox_design/aoc20xx/day15/day15.txt"))
    println("Solution for part2: " + solvePart2("de/havox_design/aoc20xx/day15/day15.txt"))
  }
