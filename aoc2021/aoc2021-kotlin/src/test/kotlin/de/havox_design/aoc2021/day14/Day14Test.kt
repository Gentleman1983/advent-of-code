...
class Day14Test {
    ...
    companion object {
        ...
        private fun getDataForTestProcessPart1(): Stream<Arguments> =
            Stream.of(
                Arguments.of("de/havox_design/aoc2021/day14/day14sample.txt", BigInteger.valueOf(1588))
            )

        @JvmStatic
        private fun getDataForTestProcessPart2(): Stream<Arguments> =
            Stream.of(
                Arguments.of("de/havox_design/aoc2021/day14/day14sample.txt", BigInteger.valueOf(2188189693529))
            )
    }
}
